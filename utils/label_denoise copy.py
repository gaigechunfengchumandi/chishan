# 这个文件是对10s数据进行降噪处理，然后保存为npy格式，用来降噪监护的数据


import os   
import numpy as np
from segment_500hz.segment_500hz_openvino import initialize_variable_s as init_seg, segment_2s
...
def main():
    # 读取命令行参数
    input_dir = '/Users/xingyulu/Public/监护心电预警/监护部门提供数据/室颤/141_10s/processed_data'
    output_dir = '/Users/xingyulu/Public/监护心电预警/监护部门提供数据/室颤/141_10s/data_denoise'
